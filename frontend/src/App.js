...
function App() {
  ...
  const handleDocumentUpload = async (e) => {
    ...
    try {
      ...
      setSuccessMessage(t.documentUploaded);
    ...
    documentUploadModal && (
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">{t.uploadDocuments}</h5>
              <button
                type="button"
                className="btn-close"
              ...
              <form onSubmit={handleDocumentUpload}>
                <div className="mb-3">
                  ...
                  >
                    ...
                    <option value="profile_photo">{t.profilePhoto}</option>
                    <option value="id_card">{t.idCard}</option>
                    <option value="medical_certificate">{t.medicalCertificate}</option>
                    <option value="residence_certificate">{t.residenceCertificate}</option>
                  </select>
                </div>
